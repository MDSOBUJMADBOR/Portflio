...
// import { Github, Linkedin, Twitter, Instagram, Facebook } from "@/lib/brand-icons"
...
//           />
//           <button className="flex items-center gap-2 px-10 py-4 bg-blue hover:bg-blue-dark text-white rounded-2xl font-bold transition-all shadow-lg shadow-blue/20 cursor-pointer">
